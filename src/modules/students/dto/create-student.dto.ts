...
export class CreateStudentDto {
    ...
    @ApiProperty({ description: 'segundo apellido estudiante', example: 'Sánchez' })
    secondLastName: string;
    @IsString({ message: 'el periodo electivo debe ser un string' })
    @IsNotEmpty({ message: 'el periodo electivo no debe estar vacio' })
    @ApiProperty({ description: 'periodo electivo estudiante', example: '2022-2023' })
    ...
    @ApiProperty({ description: 'periodo academico estudiante', example: '2022-1' })
