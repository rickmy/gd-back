...
export class CreateCareerDto {
  @ApiProperty({ type: String, description: 'Código de la carrera'})
    ...
    @ApiProperty({ type: UserByCareerDto, description: 'Coordinador de la carrera'})
    coordinator: UserByCareerDto;
    @ApiProperty({ type: UserByCareerDto, description: 'Vicecoordinador de la carrera'})
    viceCoordinator: UserByCareerDto;
    @ApiProperty({ type: UserByCareerDto, description: 'Responsable de practicas de la carrera'})
