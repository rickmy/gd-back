...
export class UserEntity implements User {
  ...
  password: string;
  @ApiProperty({ example: '2021-10-10T00:00:00.000Z', description: 'Fecha de creación', type: 'string'})
  createdAt: Date;
  @ApiProperty({ example: '2021-10-10T00:00:00.000Z', description: 'Fecha de actualización', type: 'string'})
  updatedAt: Date;
