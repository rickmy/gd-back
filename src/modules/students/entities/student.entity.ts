...
export class StudentEntity implements Student {
    ...
    firstName: string;
    @ApiProperty({ example: 'Hugo', description: 'Student second name', readOnly: true })
    secondName: string;
    @ApiProperty({ example: 'Ruiz', description: 'Student last name', readOnly: true })
    lastName: string;
    @ApiProperty({ example: 'Sánchez', description: 'Student secont last name', readOnly: true })
    secondLastName: string;
    @ApiProperty({ example: '2022-2023', description: 'Student elective period', readOnly: true })
